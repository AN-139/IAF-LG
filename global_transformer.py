...
class Global_transformer(object):
    def __init__(self, feedDict, embeddedX3, embeddedX1, embeddedX4, scope):

        self.embeddedX3 = embeddedX3
        self.embeddedX1 = embeddedX1
        self.embeddedX4 = embeddedX4
        ...
        with tf.name_scope("transformer"):
            for i in range(Config.model.numBlocks):
                with tf.name_scope("transformer".format(i + 1)):
                    multiHeadAtt = self._multiheadAttention(rawKeys=self.embeddedX, queries=self.embeddedX1,
                                                            keys=self.embeddedX4)
